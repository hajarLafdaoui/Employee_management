...
// const EditDepartment = ({ department, onClose, onSuccess, onUpdate, setShowErrorAlert }) => {
...
//       onUpdate(response.data);  // Update the department in the parent state
//       onClose();                // Close the modal
//       onSuccess();              // Trigger the success alert in MainDepartments
//     } catch (error) {
//       onClose();  // Close modal even if the request fails
//       setShowErrorAlert(true);  // Use the prop to show error alert
//       setTimeout(() => setShowErrorAlert(false), 10000);  // Hide alert after 10 seconds  
//     }
//   };
